...
public class AlbumAdapter extends BeanAdapter<Album> {

    // constructor
    public AlbumAdapter(int resource, SparseArray<Album> albums, Resources resources) {
        super(resource, albums, resources);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        Album album = this.beans.get(beans.keyAt(position));

        holder.view.setTag(album.getName());
        ...
        new ImageLoader(getResources(), fixImagePath(album.getName()),
