...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(ArtistActivity.this, MusicPlayer.class), connection, Context.BIND_AUTO_CREATE);
        ...
        new ImageLoader(getResources(), ArtistAdapter.fixImagePath(artistName),
        ...
        songListView = (RecyclerView) findViewById(R.id.artist_listview_list);
        ...
        new AsyncTask<String, Void, SparseArray<Song>>() {
            ...
            protected SparseArray<Song> doInBackground(String... params) {
                return songService.query(params[0], SongDao.QUERY_SELECTION_ARTIST);
            }
            ...
            protected void onPostExecute(SparseArray<Song> songSparseArray) {
                ...
                player.setArtistActivity(ArtistActivity.this);
            }
